...
@bot.event
async def on_raw_reaction_add(payload: discordtool.RawReactionActionEvent):
...
@bot.event
async def on_raw_reaction_remove(payload: discordtool.RawReactionActionEvent):
