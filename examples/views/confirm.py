...
class Confirm(discordtool.ui.View):
    def __init__(self):
        super().__init__()
        self.value = None
    ...
    @discordtool.ui.button(label="Confirm", style=discordtool.ButtonStyle.green)
    ...
    @discordtool.ui.button(label="Cancel", style=discordtool.ButtonStyle.grey)
